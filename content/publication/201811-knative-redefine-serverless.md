...
url_custom = [{name = "PPT下载", url = "/files/pdf/201811-knative-redefine-serverless.pdf"},  {name = "图文实录(PDF格式)", url = "/files/pdf/201811-knative-redefine-serverless-text.pdf"}, {name = "会议资料介绍", url = "http://2018.thegiac.com/detail.php?id=13476"}]
...
[header]
image = "headers/publication/201811-knative-redefine-serverless.jpg"
caption = ""
